...
class BookRepositoryTest {
    ...
    void shouldGetCountRows() {
        long jpaCount = bookRepository.count();
    ...
    void shouldFindExpectedBookById() {
        ...
        var optionalBook = bookRepository.findById(firstBook.getId());
    ...
    void shouldDeleteBookById() {
        ...
        bookRepository.deleteById(bookForDelete.getId());

        var allBooksAfterDelete = bookRepository.findAll();
        assertAll(() -> {
    ...
    void shouldNotDeleteBookIfIdIsNotInDatabase() {
        var allBooksBefore = bookRepository.findAll();
        Book fakeBook = new Book(FAKE_ID, null, null, null);
        bookRepository.delete(fakeBook);
        var allBooksAfter = bookRepository.findAll();
    ...
    void shouldUpdateBook() {
        ...
        Optional<Book> bookAfterUpdate = bookRepository.findById(bookForUpdate.getId());
