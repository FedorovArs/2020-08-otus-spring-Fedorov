...
insert into COMMENTS (id, text)
values (2, 'Классная книга');
insert into COMMENTS (id, text)
values (3, 'Рекомендую');

insert into BOOKS (id, name, author_id, genre_id, comment_id)
values (1, 'Грокаем алгоритмы', 1, 1, 1);
insert into BOOKS (id, name, author_id, genre_id, comment_id)
values (2, 'Как пасти котов', 2, 2, 2);
insert into BOOKS (id, name, author_id, genre_id, comment_id)
values (3, 'Программист-фанатик', 3, 2, 3);
